...
class CarGUI extends JFrame
{
    ...
    public CarList list[] = new CarList[2]; 

    public SortedCarList sorted = new SortedCarList(); 
    public UnsortedCarList unsorted = new UnsortedCarList(); 
    ...
    public CarGUI(String title)
    {
        ...
        //Adding a menu bar with two drop down file buttons 
    ...
    public void addToGUI(SortedCarList sorted, UnsortedCarList unsorted)
    {
        ...
        CarNode itteratorA = sorted.head.next;
        CarNode itteratorB = unsorted.head.next; 
     ...
     public void readFile(File file)
     {
         ...
         addToGUI(sorted, unsorted); 
     }

     public void clearCarGUI()
     {
         this.getContentPane().remove(leftTextArea);
         this.getContentPane().remove(rightTextArea);
     }
     

     public void addSearchGUI(CarList searchResult)
     {
         clearCarGUI(); 
         JTextArea newSpot = new JTextArea();
         this.getContentPane().add(newSpot);
         CarNode i = searchResult.head.next;

         while(i != null)
         {
             newSpot.append(i.data.toString() + "\n");
             i = i.next; 
         }
